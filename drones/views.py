...
class DroneList(generic.ListView):
    template_name = 'drones/drones.html'
...
def DroneDetails(request, pk):
    ...
    return render(request, "drones/drone_view.html", context)


class FlightsListView(generic.ListView):
    template_name = 'drones/flights_all.html'
...
class FlightDetails(generic.DetailView):
    template_name = 'drones/flight_view.html'
    model = Flights
...
def createFlight(request):
    ...
    context['form'] = form
    return render(request, 'drones/flight_add.html', context)
...
def profile(request):
    ...
    return render(request, 'drones/profile.html', context)
